...
IMPORTANT: The following admonitions apply to to the entire standard.

WARNING: Before you make any changes to your configuration, always make sure you have a backup of your system. Configuration errors can result in data loss.
