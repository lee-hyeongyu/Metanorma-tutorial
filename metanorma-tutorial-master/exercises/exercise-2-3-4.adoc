...
//Insert image here.
image::https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/GeoServer_GeoNetwork_with_web_app.svg/960px-GeoServer_GeoNetwork_with_web_app.svg.png[width=500]
